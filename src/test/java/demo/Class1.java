...
public class Class1 {
    public static void main(String args[]) throws IOException, InterruptedException {
        ...
        WebElement menu = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/deals?ref_=nav_cs_gb']")));
        ...
        WebElement deal = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='GridRow-module__container_q6XsDi4clqdE6jhYFSBW']/div[1]//a")));
        deal.click();
